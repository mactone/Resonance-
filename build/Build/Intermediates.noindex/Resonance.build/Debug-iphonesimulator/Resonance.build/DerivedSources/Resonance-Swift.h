...
#ifndef RESONANCE_SWIFT_H
#define RESONANCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Resonance",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC9Resonance11AppDelegate")
...
SWIFT_CLASS("_TtC9Resonance21AudioRecordingService")
@interface AudioRecordingService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface AudioRecordingService (SWIFT_EXTENSION(Resonance)) <AVAudioRecorderDelegate>
- (void)audioRecorderEncodeErrorDidOccur:(AVAudioRecorder * _Nonnull)recorder error:(NSError * _Nullable)error;
@end

@class MFMailComposeViewController;
SWIFT_CLASS("_TtC9Resonance20SubstackMailDelegate")
@interface SubstackMailDelegate : NSObject <MFMailComposeViewControllerDelegate>
...
/// The <code>blogURL</code> field stores the Substack email address (e.g. “mypub@substack.com”).
SWIFT_CLASS("_TtC9Resonance17SubstackPublisher")
@interface SubstackPublisher : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9Resonance10TTSService")
...
@interface TTSService (SWIFT_EXTENSION(Resonance)) <AVSpeechSynthesizerDelegate>
